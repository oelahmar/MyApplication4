...
public class MainActivity extends AppCompatActivity {
    ...
    int pos=0 ;
    //private String dateFormat=getResources().getString(R.string.format_date);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_main);
        ...
        id=(EditText) findViewById(R.id.id);nom=(EditText) findViewById(R.id.nom);
        ...
        vaccine1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
                dateVacc1.setEnabled(isChecked);vaccine2.setEnabled(isChecked);dateVacc2.setEnabled(isChecked && vaccine2.isChecked());
            }});
    ...
    public void reset(View v) {
        ...
        age.setMinValue(getResources().getInteger(R.integer.min_age));age.setMaxValue(getResources().getInteger(R.integer.max_age));age.setValue(getResources().getInteger(R.integer.normal_age));
       ...
       try {
           Date d=new SimpleDateFormat(getResources().getString(R.string.format_date)).parse(getResources().getString(R.string.min_datevaccin1));
    ...
    private void setPerson(Person item) {
        ...
        dateVacc1.setText(new SimpleDateFormat(getResources().getString(R.string.format_date)).format(item.getDateVacc1()));
        ...
        List<String>villes=Arrays.asList(getResources().getStringArray(R.array.ville_array));ville.setSelection(villes.indexOf(item.getVille()));
    ...
    private Person getPerson(boolean isnew) {
        ...
        if(vaccine1.isChecked()){
            try{p.setDateVacc1(new SimpleDateFormat(getResources().getString(R.string.format_date)).parse(dateVacc1.getText().toString()));}
            ...
            if(vaccine2.isChecked()){
                ...
                catch(PersonException e){Toast.makeText(MainActivity.this,e+"",Toast.LENGTH_SHORT).show();return null;}
            }
        }
